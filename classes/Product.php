...
class Product{
	...
	public function insertCompareData($productId,$cmrId){
		...
		if ($check) {
			$msg="<span class='error'>Already added compare page!</span>";
				return $msg;
		}
	...
	public function delCompareProduct($proid,$cmrId){
		$query="DELETE FROM tbl_compare where productID='$proid' AND cmrId='$cmrId'";
		$delCompProduct=$this->db->delete($query);
		return $delCompProduct;
	}
	...
	public function saveWishListData($id,$cmrId){
		...
		$check=$this->db->select($cquery);
		if ($check) {
			$msg="<span class='error'>Already added WishList page!</span>";
				return $msg;
		}
		$query ="SELECT * FROM tbl_product WHERE productID='$id'";
		$result=$this->db->select($query)->fetch_assoc();
	...
	public function delWishListData($proid,$cmrId){
